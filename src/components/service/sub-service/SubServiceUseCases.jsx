      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          {list.map((item, index) => (
            <div 
              key={index} 
              className="w-full md:w-[calc(50%-12px)] lg:w-[calc(33.333%-16px)] p-12 bg-zinc-900/40 border-2 border-white/10 rounded-2xl hover:bg-zinc-900/60 hover:border-zinc-700 transition-all duration-300 flex flex-col items-center justify-center min-h-[200px]"
            >
        ...
        {conclusionLine && (
          <div className="mt-12">
            <p className="text-zinc-500 text-sm md:text-base max-w-5xl mx-auto leading-relaxed font-light">
              {conclusionLine}
            </p>
          </div>
        )}
