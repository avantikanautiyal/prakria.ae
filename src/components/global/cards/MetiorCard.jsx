  ...
  return (
    <div className="justify-center items-center w-full flex wow animate fadeInUp">
      <div className=" w-full relative max-w-xs">
        ...
        <div className="relative shadow-xl footer-section style-2 border border-gray-800  px-4 py-8 h-full overflow-hidden rounded-2xl flex flex-col justify-end items-start">
